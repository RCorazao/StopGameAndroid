...
@Composable
fun RoomInfoCard(room: RoomDto?, statusText: String = stringResource(R.string.status_waiting_players)) {
        Card(
...
fun LeaveRoomCard(onLeaveRoom: () -> Unit) {
        Card(
                ...
                OutlinedButton(
                        ...
                        Spacer(Modifier.width(8.dp))
                        Text(stringResource(R.string.leave_room), fontWeight = FontWeight.Medium, fontSize = 16.sp)
                }
        }
}
...
fun GameScreenLayout(
        ...
        val unreadMessageCount =
                chatViewModel.unreadMessageCount.collectAsStateWithLifecycle().value
